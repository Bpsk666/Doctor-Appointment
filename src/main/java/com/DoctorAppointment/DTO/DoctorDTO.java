...
public class DoctorDTO {
    ...
    public DoctorDTO(String docFName, String docLName, int docAge, String specialty, String qualification, int experience, String docPhone, String docAddress, String docEmail,String docPassword,double aptFee, MultipartFile profileImage) {
